      ...
      return (
        ...
        <div className="d-flex justify-content-center" style={{marginTop:'2%'}}>
                ...
                <div className="d-flex justify-content-start">
                      ...
                      <button className="btn btn" onClick={this.checkouthandler} style={{color:'white',borderRadius:'5%',height:"90%",borderEndStartRadius:'5%',backgroundColor:"#5680E9"}}>CheckOut</button>
