    ...
    render() {
        ...
        var patientdetails = this.state.display.map(name1 => {
            return (
                ...
                <h4 style={{fontSize:'14px',marginTop:'1%'}}><b>Name: </b>{name1.name}</h4> 
        ...
        return (
            ...
            (this.state.isDataAvailable &&
                ...
                <h3><button className="btn btn" style={{backgroundColor:'#116466',height:'70%',marginBottom:'10%',fontSize:'70%',padding:'1%'}}><b>Blood Group: {this.props.location.state.bloodgroup} </b></button></h3>
                </div>
                </div>
                    {
                        patientdetails
